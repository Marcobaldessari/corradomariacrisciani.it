    ...
    <nav class="menu menu-vertical menu-left " id="menu-s1">
        ...
        <div class="nav_wrapper transparent">
            <ul>
                ...
                <li><a class="sub active" href="polimi-corsi.php">Polimi Corsi</a></li>
                <li><a class="sub" href="polimi-fit.php">polimi fit</a></li>
                <li><a class="sub" href="polimi-tesi.php">polimi tesi</a></li>
                <li><a class="sub" href="accademia-scala.php">Accademia della scala</a></li>
                <li><a class="sub" href="ws-tutor.php">WS tutor</a></li>
                <li><a class="sub" href="ricerca.php">Ricerca</a></li>
                <li><a target="_blank" class="sub" href="https://www.youtube.com/watch?v=mSPlVq3HNtQ&list=PLIa503agTspK6PSvufMSbfjGccJpMF_Cs">Video</a></li>
            </ul>
                    ...
                    <section class="slider">
                        <div id="slider" class="flexslider">
                            ...
                            // Inizio script per il caricamento di file da ftp
                                $path = '/img/gallery/docenza/polimi-corsi';
                                $files = array();
