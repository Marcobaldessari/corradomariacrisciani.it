    ...
    <nav class="menu menu-vertical menu-left " id="menu-s1">
        ...
        <div class="nav_wrapper transparent">
            <ul>
                ...
                <li><a class="sub active" href="de-carli-triennale.php">De Carli Triennale</a></li>
                <li><a class="sub" href="palladio-digitale.php">Palladio Digitale</a></li>
                <li><a class="sub" href="studio-castiglioni.php">Studio Castiglioni</a></li>
                    ...
                    <section class="slider">
                        <div id="slider" class="flexslider">
                            ...
                            // Inizio script per il caricamento di file da ftp
                                $path = '/img/gallery/docenza/ricerca/de-carli-triennale';
                                $files = array();
