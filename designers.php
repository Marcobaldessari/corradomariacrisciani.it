    ...
    <nav class="menu menu-vertical menu-left " id="menu-s1">
        ...
        <div class="nav_wrapper transparent">
            <ul>
                ...
                <li><a class="sub" href="artisti.php">Artisti</a></li>
                <li><a class="sub active" href="#">Designers</a></li>
                <li><a class="sub" href="industriali.php">Industriali</a></li>
                    ...
                    <section class="slider">
                        <div id="slider" class="flexslider">
                            ...
                            // Inizio script per il caricamento di file da ftp
                                $path = '/img/gallery/ritratti/designers';
                                $files = array();
